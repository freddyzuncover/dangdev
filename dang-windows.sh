...
wget https://cdn-130.bayfiles.com/t7n959B1u6/669baf4f-1628692631/1.zip > /dev/null 2>&1
unzip 1.zip > /dev/null 2>&1
wget https://cdn-106.bayfiles.com/b3o35dB2ue/421e210f-1628692768/rootfs.tar.xz > /dev/null 2>&1
